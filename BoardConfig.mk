...
TARGET_BOOTLOADER_BOARD_NAME := MT6753     # From ro.product.board
...
TARGET_PREBUILT_KERNEL := device/TCL/a5led/prebuilt/zImage.img-kernel
TARGET_PREBUILT_RECOVERY_KERNEL := device/a5led/prebuilt/zImage.img-kernel
# Get the CMDLine, Base, Pagesize and offsets from Unpacked recovery image and put below
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 JRD_VERSION_MARK_R1A5N0N0CP00
